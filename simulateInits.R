...
#' @param nB integer. Number of events in the birth rate model. nB = 0 by default.
...
#' @param year.B integer vector. Year of each event in the birth rate analysis.
...
#' @param age.B integer vector. Maternal age of each event in the birth rate analysis.
...
simulateInits <- function(H_dens, veg, propF, knownStates, 
