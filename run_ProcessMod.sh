#!/bin/bash
#SBATCH --job-name=IPM_muFunE             # Nom de la tâche
#SBATCH --output=job_output_muFunE.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_muFunE.txt      # Fichier d'erreur (unique par tâche)
