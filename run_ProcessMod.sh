#!/bin/bash
#SBATCH --job-name=RooIPM_3Covs          # Nom de la tâche
#SBATCH --output=job_output_3Covs.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_3Covs.txt      # Fichier d'erreur (unique par tâche)
