#!/bin/bash
#SBATCH --job-name=RooIPM_dCJS_20          # Nom de la tâche
#SBATCH --output=job_output_dCJS_20.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_dCJS_20.txt      # Fichier d'erreur (unique par tâche)
