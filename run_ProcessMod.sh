#!/bin/bash
#SBATCH --job-name=RooIPM_0Covs          # Nom de la tâche
#SBATCH --output=job_output_0Covs.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_0Covs.txt      # Fichier d'erreur (unique par tâche)
