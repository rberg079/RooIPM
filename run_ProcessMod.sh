#!/bin/bash
#SBATCH --job-name=RooIPM_DcovHpop          # Nom de la tâche
#SBATCH --output=job_output_DcovHpop.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_DcovHpop.txt      # Fichier d'erreur (unique par tâche)
