#!/bin/bash
#SBATCH --job-name=RooIPM_DaveNoVeg          # Nom de la tâche
#SBATCH --output=job_output_DaveNoVeg.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_DaveNoVeg.txt      # Fichier d'erreur (unique par tâche)
