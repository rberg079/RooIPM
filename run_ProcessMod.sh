#!/bin/bash
#SBATCH --job-name=RooIPM_base          # Nom de la tâche
#SBATCH --output=job_output_base.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_base.txt      # Fichier d'erreur (unique par tâche)
