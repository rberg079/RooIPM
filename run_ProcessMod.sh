#!/bin/bash
#SBATCH --job-name=RooIPM_HcovDpop          # Nom de la tâche
#SBATCH --output=job_output_HcovDpop.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_HcovDpop.txt      # Fichier d'erreur (unique par tâche)
