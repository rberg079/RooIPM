#!/bin/bash
#SBATCH --job-name=RooIPM_NAs          # Nom de la tâche
#SBATCH --output=job_output_NAs.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_NAs.txt      # Fichier d'erreur (unique par tâche)
