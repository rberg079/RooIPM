#!/bin/bash
#SBATCH --job-name=RooIPM_dCJS          # Nom de la tâche
#SBATCH --output=job_output_dCJS.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_dCJS.txt      # Fichier d'erreur (unique par tâche)
