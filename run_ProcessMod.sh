#!/bin/bash
#SBATCH --job-name=IPM_areaHR             # Nom de la tâche
#SBATCH --output=job_output_areaHR.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_areaHR.txt      # Fichier d'erreur (unique par tâche)
