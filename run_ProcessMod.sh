#!/bin/bash
#SBATCH --job-name=RooIPM_Hpop          # Nom de la tâche
#SBATCH --output=job_output_Hpop.txt    # Fichier de sortie (unique par tâche)
#SBATCH --error=job_error_Hpop.txt      # Fichier d'erreur (unique par tâche)
